...
summary: NFS sobre TLS funciona com os controles de política de exportação padrão do ONTAP e replica por meio do SVM-DR e do MetroCluster. Esta página também aborda limites de conexão, comportamento de aplicação de políticas e recomendações operacionais. 
---
