...
Para obter mais informações sobre como os volumes FlexGroup se beneficiam da arquitetura AFX, consulte link:afx-architecture.html#flexgroup-volume-management-improvements["FlexGroup melhorias no gerenciamento de volumes"].
