...
link:https://www.netapp.com/pdf.html?item=/media/83591-tr-4963.pdf["TR-4963: Guia de reforço de segurança: NetApp Backup and Recovery for Applications"^]Aprenda a configurar o NetApp Cloud Backup for Applications para ajudar as organizações a atingir os objetivos de segurança prescritos para confidencialidade, integridade e disponibilidade do sistema de informações.
