...
[[netapps-ransomware-protection-portfolio]]
...
NOTE: NetApp ONTAP atende à necessidade de acesso baseado na Web https://www.netapp.com/pdf.html?item=/media/17055-tr4647.pdf["Autenticação multifator (MFA)"^] no System Manager e de autenticação SSH CLI.
