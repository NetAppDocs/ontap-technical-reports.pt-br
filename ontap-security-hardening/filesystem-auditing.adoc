...
NOTE: A API REST /api/storage/volumes é usada para mais do que apenas acesso a arquivos. Ela é usada pelo System Manager e outras interfaces gráficas para criar, visualizar e modificar volumes.
