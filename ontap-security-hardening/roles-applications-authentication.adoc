...
Para obter mais informações sobre autenticação multifator (MFA) para ONTAP System Manager, Active IQ Unified Manager e SSH, consulte link:https://www.netapp.com/pdf.html?item=/media/17055-tr4647.pdf["TR-4647: Autenticação multifator no ONTAP 9"^].
